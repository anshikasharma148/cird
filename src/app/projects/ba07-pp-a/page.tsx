              ...
              <Card className="bg-gradient-to-br from-slate-800 to-slate-700 border-slate-600 h-full">
                ...
                <CardContent>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-red-400 rounded-full mr-3"></div>
                      <span className="text-gray-300">Lambagad Khiro Station</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-slate-800 to-slate-700 border-slate-600 h-full">
                <CardHeader>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <CardTitle className="text-xl text-white">Data Transmission & Visualization</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300 mb-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-300">Real-time monitoring and visualization</span>
                    </div>
                    <div className="flex items-center">
                      <Monitor className="w-5 h-5 text-white mr-3" />
                      <span className="text-gray-300">Historical data analysis</span>
                    </div>
                    <div className="flex items-center">
                      <Monitor className="w-5 h-5 text-white mr-3" />
                      <span className="text-gray-300">Early warning alerts</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
