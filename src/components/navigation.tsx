            ...
            <NavigationMenu className="hidden lg:block flex-1">
              <NavigationMenuList className="flex flex-wrap justify-end gap-1 md:gap-2">
                <NavigationMenuItem>
                  <Link 
                    href="/" 
                    className={`group relative inline-flex h-10 w-max items-center justify-center rounded-lg px-3 md:px-4 py-2 text-sm font-semibold transition-all duration-300 ${
                      isActive("/") 
                ...
                <NavigationMenuItem>
                  <div className="relative group/nav">
                    <NavigationMenuTrigger 
                      className={`relative bg-transparent cursor-pointer px-3 md:px-4 text-sm font-semibold h-10 rounded-lg transition-all duration-300 ${
                        isActive("/research") || isActive("/projects")
            ...
            {isMobileMenuOpen && (
              ...
              <div className="px-3 sm:px-4 py-4 sm:py-5 space-y-1 sm:space-y-2">
                <Link 
                  ...
                  className={`block px-4 sm:px-5 py-3 sm:py-2.5 text-sm sm:text-base rounded-lg transition-all duration-200 font-semibold ${
                    isActive("/")
                ...
                <Link 
                  href="/research" 
                  onClick={() => setIsMobileMenuOpen(false)}
                  className={`block px-6 sm:px-8 py-2.5 sm:py-2 text-sm sm:text-base rounded-lg transition-all duration-200 ${
                    isActive("/research")
